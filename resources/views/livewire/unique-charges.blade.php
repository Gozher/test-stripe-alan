                ...
                <div class=" flex flex-justify-center items-center m-4">
                        ...
                        <div class="mt-10">
                            ...
                            <div class="ml-10 w-10/12 mx-auto">
                                ...
                                <select wire:model="amount"
                                    class="mt-2 bg-gray-100 form-select text-sm w-full text-gray-700 py-2 px-3 rounded-md shadow-sm transition duration-150 ease-in-out sm:text-sm sm:leading-5 border-none">
                                    <option value="" hidden>selecciona un monto</option>
                                    @for ($i = 0; $i < 10; $i++) <option value="{{ ($i+1) * 100 }}"> Costo :
                                        {{ ($i+1) * 100 }}</option>
                                        @endfor
                                </select>
                    ...
                    <div class="flex flex-col items-center justify-center shadow-lg w-3/6 m-4">
                        ...
                        <div class="flex flex-col justify-center items-center my-1  w-6/12">
                            ...
                            <div class="">
                                <input wire:model="cvc" type="text" name=""
                                    class="mt-2 bg-gray-100 form-input text-sm w-full py-2 px-3 rounded-md shadow-sm transition duration-150 ease-in-out sm:text-sm sm:leading-5 border-none text-gray-700">
                        ...
                        <div class="my-1 text-center w-full my-4">
                            @if($amount != null)
                            <button wire:click="buy" name="button"
                                class="bg-indigo-500 px-2 py-1 text-white w-4/12">Comprar</button>
                            @endif
                        </div>
                    ...
                    <div class="h-auto flex flex-col items-center justify-center shadow-lg mx-auto p-4">
                        <div class="border w-full p-4">Marca : {{$brand}}</div>
                        <div class="border w-full p-4">Metodo de pago : **** **** **** {{$numberCard}}</div>
                        @if($amount != null)
                        <div class="my-1 text-center w-full my-4">
                            <button wire:click="buy" name="button"
                                class="bg-indigo-500 px-2 py-1 text-white w-4/12">Comprar</button>
